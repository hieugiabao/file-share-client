...
class Ui_Register(object):
    def setupUi(self, Register):
        ...
        Register.resize(692, 613)
        self.widget = QWidget(Register)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(0, 0, 481, 291))
        self.label = QLabel(self.widget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(160, 20, 191, 51))
        font = QFont()
        ...
        self.label_3.setGeometry(QRect(60, 180, 71, 16))
        self.pushButton = QPushButton(self.widget)
        self.pushButton.setObjectName(u"pushButton")
        self.pushButton.setGeometry(QRect(150, 220, 75, 24))
        self.pushButton_2 = QPushButton(self.widget)
        self.pushButton_2.setObjectName(u"pushButton_2")
        self.pushButton_2.setGeometry(QRect(320, 220, 91, 24))
        self.error_label = QLabel(self.widget)
        self.error_label.setObjectName(u"error_label")
        self.error_label.setGeometry(QRect(150, 70, 261, 16))
